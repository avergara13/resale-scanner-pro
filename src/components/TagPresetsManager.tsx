...
const DEFAULT_TAG_PRESETS: TagPreset[] = [
  {
    id: 'high-value-vintage',
    name: 'High Value Vintage',
    description: 'Premium vintage items with exceptional resale potential',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 'hvv-tag-1', name: 'High Value', color: 'oklch(0.65 0.20 260)' },
      { id: 'hvv-tag-2', name: 'Vintage', color: 'oklch(0.68 0.18 75)' },
      { id: 'hvv-tag-3', name: 'Investment Piece', color: 'oklch(0.52 0.20 145)' },
      { id: 'hvv-tag-4', name: 'Collectible', color: 'oklch(0.50 0.18 250)' },
      { id: 'hvv-tag-5', name: 'Rare', color: 'oklch(0.52 0.22 25)' },
    ],
  },
  {
    id: 'designer-fashion',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 'df-tag-1', name: 'Designer', color: 'oklch(0.65 0.20 260)' },
      { id: 'df-tag-2', name: 'Luxury Brand', color: 'oklch(0.68 0.18 75)' },
      { id: 'df-tag-3', name: 'Authenticated', color: 'oklch(0.52 0.20 145)' },
      { id: 'df-tag-4', name: 'Like New', color: 'oklch(0.50 0.18 250)' },
      { id: 'df-tag-5', name: 'Original Tags', color: 'oklch(0.52 0.22 25)' },
    ],
  },
  {
    id: 'vintage-electronics',
    name: 'Vintage Electronics',
    description: 'Retro tech and vintage electronic collectibles',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 've-tag-1', name: 'Vintage', color: 'oklch(0.68 0.18 75)' },
      { id: 've-tag-2', name: 'Electronics', color: 'oklch(0.50 0.18 250)' },
      { id: 've-tag-3', name: 'Working', color: 'oklch(0.52 0.20 145)' },
      { id: 've-tag-4', name: 'Collectible', color: 'oklch(0.65 0.20 260)' },
      { id: 've-tag-5', name: 'Original Box', color: 'oklch(0.68 0.18 75)' },
    ],
  },
  {
    id: 'streetwear-hype',
    name: 'Streetwear & Hype',
    description: 'Limited edition streetwear and hyped items',
    category: 'fashion',
    icon: 'tshirt',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 'sh-tag-1', name: 'Streetwear', color: 'oklch(0.52 0.22 25)' },
      { id: 'sh-tag-2', name: 'Limited Edition', color: 'oklch(0.68 0.18 75)' },
      { id: 'sh-tag-3', name: 'Hype', color: 'oklch(0.65 0.20 260)' },
      { id: 'sh-tag-4', name: 'Deadstock', color: 'oklch(0.52 0.20 145)' },
      { id: 'sh-tag-5', name: 'Authenticated', color: 'oklch(0.50 0.18 250)' },
    ],
  },
  {
    id: 'vintage',
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'electronics-tag-4', name: 'Original Box', color: 'oklch(0.68 0.18 75)' },
    ],
  },
  {
    id: 'high-value',
    ...
    tags: [
      ...
      { id: 'high-value-tag-4', name: 'Investment Piece', color: 'oklch(0.52 0.20 145)' },
    ],
  },
  {
    id: 'clothing',
  ...
  },
  {
    ...
    description: 'Sports memorabilia, cards, and vintage sports items',
    category: 'collectibles',
    icon: 'sparkle',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 'sc-tag-1', name: 'Sports', color: 'oklch(0.52 0.20 145)' },
      { id: 'sc-tag-2', name: 'Memorabilia', color: 'oklch(0.68 0.18 75)' },
      { id: 'sc-tag-3', name: 'Collectible', color: 'oklch(0.50 0.18 250)' },
      { id: 'sc-tag-4', name: 'Authenticated', color: 'oklch(0.52 0.22 25)' },
      { id: 'sc-tag-5', name: 'Vintage', color: 'oklch(0.65 0.20 260)' },
    ],
  },
  {
    id: 'bulk-lot',
  ...
  {
    id: 'home-decor-vintage',
    name: 'Vintage Home Decor',
    description: 'Retro and vintage home decor and furniture',
    ...
    updatedAt: Date.now(),
    tags: [
      { id: 'hd-tag-1', name: 'Home Decor', color: 'oklch(0.65 0.20 260)' },
      { id: 'hd-tag-2', name: 'Vintage', color: 'oklch(0.68 0.18 75)' },
      { id: 'hd-tag-3', name: 'Mid-Century', color: 'oklch(0.50 0.18 250)' },
      { id: 'hd-tag-4', name: 'Collectible', color: 'oklch(0.52 0.20 145)' },
      { id: 'hd-tag-5', name: 'Rare Find', color: 'oklch(0.52 0.22 25)' },
    ],
  },
]
