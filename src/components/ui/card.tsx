...
function Card({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "material-thin text-card-foreground flex flex-col gap-5 rounded-2xl border border-border/80 py-5 shadow-[var(--material-shadow)]",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("font-sans text-headline leading-none text-label", className)}
      {...props}
    />
  )
}
