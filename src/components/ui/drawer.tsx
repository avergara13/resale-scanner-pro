  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content material-regular fixed z-50 flex h-auto flex-col border border-border/80 shadow-[var(--material-shadow)]",
        ...
        {...props}
      >
        <div className="mx-auto mt-3 hidden h-1.5 w-9 shrink-0 rounded-full bg-tertiary-label/60 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
