      ...
      <header className="sticky top-0 z-10 bg-fg border-b border-s1 p-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-black tracking-tight text-t1">TAG ANALYTICS</h1>
            <p className="text-[10px] text-t3 font-medium uppercase tracking-wider">
              Track which tags drive best ROI
            </p>
          </div>
          <div className="w-10 h-10 bg-gradient-to-br from-b1 to-amber rounded-xl flex items-center justify-center">
